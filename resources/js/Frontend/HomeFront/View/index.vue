        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <a class="box_work" href="submit_restaurant.html">
                    <img src="/assets/img/submit_restaurant.jpg" width="848" height="480" alt="" class="img-fluid">
            ...
            <div class="col-md-5">
                <a class="box_work" href="submit_driver.html">
                    <img src="/assets/img/delivery.jpg" width="848" height="480" alt="" class="img-fluid">
