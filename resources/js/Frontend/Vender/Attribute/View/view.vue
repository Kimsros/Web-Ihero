    ...
    methods:{
        ...
        SaveUpdate(){
            if(this.form.id==null){
                axios.post('/api/vender/attribute/add',this.form).then(respon=>{
                ...
                axios.post('/api/vender/attribute/update/'+this.form.id,this.form).then(respon=>{
                    if(respon.data.data){
                        this.$swal.fire(
                            {
                                toast:true,
        ...
        Destroy(id){
            ...
            confirmButtonText: 'Yes, delete it!'
                ...
                if (result.isConfirmed) {
                    axios.post('/api/vender/attribute/destroy/'+id).then(respon=>{
